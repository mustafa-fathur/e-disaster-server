...
class DisasterController extends Controller
{
    ...
    *         @OA\Schema(
    *             type="string",
    *             enum={"earthquake","tsunami","volcanic_eruption","flood","drought","tornado","landslide","non_natural_disaster","social_disaster"},
    *             example="earthquake"
    *         )
    *     ),
     *     @OA\Response(
    ...
    *                 @OA\Property(property="source", type="string", enum={"bmkg","manual"}),
    *                 @OA\Property(property="type", type="string", enum={"earthquake","tsunami","volcanic_eruption","flood","drought","tornado","landslide","non_natural_disaster","social_disaster"}),
    *                 @OA\Property(property="status", type="string", enum={"ongoing","completed","cancelled"}),
    *                 @OA\Property(property="date", type="string", format="date"),
    *                 @OA\Property(property="time", type="string"),
    *                 @OA\Property(property="location", type="string"),
    *                 @OA\Property(property="coordinate", type="string", nullable=true),
    *                 @OA\Property(property="lat", type="number", nullable=true),
    *                 @OA\Property(property="long", type="number", nullable=true),
    *                 @OA\Property(property="magnitude", type="number", nullable=true),
    *                 @OA\Property(property="depth", type="number", nullable=true),
    ...
    *                 @OA\Property(property="completed_by", type="string", nullable=true),
    ...
    public function index(Request $request)
    {
        ...
        $data = collect($disasters->items())->map(function ($d) use ($picsById) {
            ...
            return [
                ...
                'cancelled_at' => $d->cancelled_at?->format('Y-m-d H:i:s'),
    ...
    *             @OA\Schema(
    *                 required={"title","type","source","date","time"},
    ...
    *                 @OA\Property(property="type", type="string", enum={"earthquake","tsunami","volcanic_eruption","flood","drought","tornado","landslide","non_natural_disaster","social_disaster"}, example="earthquake"),
    *                 @OA\Property(property="source", type="string", enum={"bmkg","manual"}, example="bmkg"),
    *                 @OA\Property(property="status", type="string", enum={"ongoing","completed","cancelled"}, example="ongoing"),
    *                 @OA\Property(property="location", type="string", example="Jakarta, Indonesia"),
    *                 @OA\Property(property="coordinate", type="string", example="6.2088,106.8456"),
